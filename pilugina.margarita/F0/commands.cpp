...
void pilugina::createDict(std::istream &in, std::ostream &out, dictionaries &dicts)
{
  std::string dictName;
...
void pilugina::deleteDict(std::istream &in, std::ostream &out, dictionaries &dicts)
{
  std::string dictName;
  if (!read1Word(in, dictName))
  {
...
void pilugina::insertWord(std::istream &in, std::ostream &out, dictionaries &dicts)
{
...
void pilugina::insertTranslation(std::istream &in, std::ostream &out, dictionaries &dicts)
{
...
void pilugina::removeWord(std::istream &in, std::ostream &out, dictionaries &dicts)
{
  std::string dictName, word;
  if (!read2Words(in, dictName, word))
  {
...
void pilugina::removeTranslation(std::istream &in, std::ostream &out, dictionaries &dicts)
{
  std::string dictName, word, translation;
  if (!read3Words(in, dictName, word, translation))
  {
...
void pilugina::searchTranslation(std::istream &in, std::ostream &out, const dictionaries &dicts)
{
  std::string dictName, word;
  if (!read2Words(in, dictName, word))
  {
...
void pilugina::printSizeDict(std::istream &in, std::ostream &out, const dictionaries &dicts)
{
  std::string dictName;
  if (!read1Word(in, dictName))
  {
...
void pilugina::printDict(std::istream &in, std::ostream &out, const dictionaries &dicts)
{
  std::string dictName;
  if (!read1Word(in, dictName))
  {
...
void pilugina::saveDict(std::istream &in, std::ostream &out, const dictionaries &dicts)
{
...
void pilugina::mergeDicts(std::istream &in, std::ostream &out, dictionaries &dicts)
{
  std::string a, b, dest;
...
void pilugina::joinDicts(std::istream &in, std::ostream &out, dictionaries &dicts)
{
  std::string a, b;
...
void pilugina::innerMerge(std::istream &in, std::ostream &out, dictionaries &dicts)
{
  std::string a, b, dest;
  if (!read3Words(in, a, b, dest))
  {
...
void pilugina::mergeTranslations(std::istream &in, std::ostream &out, dictionaries &dicts)
{
  std::string a, b;
  if (!read2Words(in, a, b))
  {
